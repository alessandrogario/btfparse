use crate::btf::{
    Array, Const, DataSec, DeclTag, Enum, Enum64, FileHeader, Float, Func, FuncProto, Fwd, Int,
    Kind, Ptr, Readable, Restrict, Result as BTFResult, Struct, Type, TypeHeader, TypeTag, Typedef,
    Union, Var, Volatile,
};
